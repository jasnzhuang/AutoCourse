...
using AutoCourse.DAL;

namespace AutoCourse.BLL
{
    public class ACBaseServices<T> where T : class
    {
        ACBaseDBOption<T> _ACBaseDBOption;

        public ACBaseServices()
        {
            _ACBaseDBOption = new ACBaseDBOption<T>();
        }
        ...
        public T Add(T entity, bool IsSave = true)
        {
            ...
            return _ACBaseDBOption.Add(entity, IsSave);
        }
        ...
        public T UpDate(T entity, bool IsSave = true)
        {
            ...
            return _ACBaseDBOption.UpDate(entity, IsSave);
        }
        ...
        {
            return _ACBaseDBOption.Delete(entity, IsSave);
        }
        ...
        {
            return _ACBaseDBOption.Find(keyvalues);
        }
        ...
        {
            return _ACBaseDBOption.Find(lambda);
        }
